...
# 用 dropout 包装原始模型
dropout_rate = 0  # 你可以根据需要调整 dropout 率
...
# Step 2: 从本地文件加载模型参数
#model.load_state_dict(torch.load("vitb1621k_with_custom_head.pth"))
...
optimizer = optim.SGD(pg, lr=0.001, momentum=0.92, weight_decay=1E-5)
#optimizer.load_state_dict(torch.load('./m/Epoch5optimizer_state_continued.pth'))
...
#            print(outputs.shape)
        ...
        now_model=model_with_dropout.state_dict()
