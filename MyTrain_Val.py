...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_root', type=str, default='./COD10K-v3/Train/',
                        help='the training rgb images root')                #此处是编辑要处理的训练的图片的地址
    parser.add_argument('--val_root', type=str, default='./CAMO',
                        help='the test rgb images root')          #此处是验证集的导入路径
    parser.add_argument('--save_path', type=str,
                        default='./trainsave/',
                        help='the path to save model and log')           #模型保存地址
    ...
    train_loader = get_loader(image_root=opt.train_root + 'Image/',
                              ...
                              num_workers=8)
    val_loader = test_dataset(image_root=opt.val_root + '/Images/Train/',
